      ...
      <View style={styles.bottomContainer}>
        <View style={styles.textBox}>
          ...
          <Text style={styles.description}>
            A fine tribe is built when we handpick them. We value your judgement  of reference and when your referral joins, <Text style={styles.title1}>INR 40,000</Text> will be added to your wallet as a token of appreciation.
          </Text>
        </View>
