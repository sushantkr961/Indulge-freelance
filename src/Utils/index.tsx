...
const FAQSDATA = [
    {
        ...
        "answer": "INDULGE is NOT a discounting platform. We are enabler optimised to support you and offer convenience. Think of it as an EA but on steroids (with global access)"
    },
    {
        "id": 1,
        "question": "What is the scope of requests I can make?",
        "answer": "No request is too big. From sending flowers to jets and sails, restaurant reservations to sports and music tickets, buying bags and watches to medical assistance- we will cover you."
    },
    {
        "id": 2,
        "question": "How many people can use the membership?",
        "answer": "You and a +1 can use an individual membership wherein you will be addressed by the same team. In case the 2 individuals wish to keep their requests isolated from the other- another membership has to be activated."
    },
    {
        "id": 3,
        "question": "How do I make payments for my request?",
        "answer": "Mode of payment can be UPI, bank transfer (domestic or international), credit and debit card"
    },
    {
        "id": 4,
    ...
    {
        "id": 5,
        "question": "Can I have a monthly subscription?",
        "answer": ` Our monthy membership is available at INR 40000. You can experience the membership and as per request increase your subscription months.`
    },
    {
        "id": 6,
...
const MyCoupanData = [
    {
        "id": 0,
        "code": "ROLLSROYCE30",
        "answer": "Anyone who has a rollsroyce can have a 30% off"
    },
    {
        "id": 1,
        "code": "JET66",
        "answer": "Anyone who has a Private Jet can have a 66% off"
    },
    {
        "id": 2,
        "code": "ROLLSROYCE30",
...
export { flowerStatuses, statusOptions, travelStatuses, stayStatuses, preferStatuses, foodStatuses, dietStatuses, coffeeStatuses, languageStatuses, tasteData, FAQSDATA, MyCoupanData }
...
export const formatValue = (value: number) => {
    ...
    } else if (value >= 100000) {  // 1 lakh (100 thousand)
...
const [reelsData, setReelsData] = [
    {
        "_id": "66d06c31a0bcad62572b31ad",
        "title": "Probiotics",
        "description": "restoring the skin's natural balance",
        "videoUrl": "https://d13pwi6da1y6cp.cloudfront.net/Beauty%20and%20Fragrance%2FindulgeBeautyProbioticsForSkinCare.mp4",
        "tags": [
