...
// const SingleReel = ({ index, videoViewStyle, item }) => {
//     console.log("INDEXXXXX_____", item);
//     const videoId = index % 2 === 0 ? '-CnFtHhNQlE' : '01uKTK-oSdQ';

//     const videoUrl = `https://www.youtube.com/embed/${videoId}?autoplay=0&controls=0&modestbranding=1&rel=0&mute=0&playsinline=1&cc_load_policy=0&loop=1&playlist=${videoId}`;

//     // const videoUrl = item.index % 2 === 0
//     //     ? 'https://www.youtube.com/embed/-CnFtHhNQlE?loop=1&autoplay=1&cc_load_policy=0&controls=0&modestbranding=1&rel=0&showinfo=0&mute=0&playsinline=1'
//     //     : 'https://www.youtube.com/embed/01uKTK-oSdQ?loop=1&autoplay=1&cc_load_policy=0&controls=0&modestbranding=1&rel=0&showinfo=0&mute=0&playsinline=1';
...
//                 allowsInlineMediaPlayback={true} // For iOS to allow inline play
//             />
//         </View>
//     );
// };
...
import { Pressable, ActivityIndicator, View, Dimensions, Text, Alert, Share, TouchableOpacity, Image, StyleSheet, Platform, Linking, ImageBackground } from 'react-native';
