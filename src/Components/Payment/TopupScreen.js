...
// import PaymentScreen from './GpayCode';
...
//     const funds = route.params?.funds || '';
...
//     const { mobile_no, profileDetails, region, currency } = useAppSelector((state) => state.profileDetails);
//     useEffect(() => {
//         if (funds) {
//             setEnteredAmount(funds.toString()); // Ensure funds is a string
//         }
//     }, [route])
...
//                 'https://indulgeconcierge.com/add-funds',
//                 {
//                     amount,
...
//             console.log('Amount:', amount);
//             const response = await axios.post("https://indulgeconcierge.com/update-balance", {
//                 mobile_no: phoneNumber,
...
//                 {"\n"}
//                 <Text style={styles.text2}>{currency}{walletBalance?.toLocaleString()}</Text>
//             </Text>
...
//                         <Image source={require('../assets/Gpay.png')} style={styles.gpayLogo} />
...
//                 <Pressable style={styles.gpayButton}>
//                     <View style={{ flexDirection: 'row' }}>
//                         <Image source={require('../assets/Paypal.png')} style={styles.paypalLogo} />
