...
const VideoPlayModal: React.FC<VideoPlayModalProps> = ({
    ...
    const handleSlideComplete = (value: any) => {
            ...
            <SafeAreaView style={styles.modalContainer}>
                ...
                >
                    <Video
                        ref={videoPlayer}
                        // autoPlay
                        source={videoLink == "VIDEO1.mp4" ? require(`../../assets/video/VIDEO1.mp4`) : videoLink == "VIDEO2.mp4" ? require(`../../assets/video/VideoEnhancer002.mp4`) : { uri: videoLink }}
                        style={{
                            flex: 1,
                            width: windowWidth,
                            height: windowHeight,
